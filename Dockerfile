...
#    mvn -B package -DskipTests -Pbuild-distr -Pspark-3.0 -Pinclude-hadoop -Phadoop3 -Pspark-scala-2.12 -Pweb-angular && \
    ...
    mvn -B package -DskipTests -Pbuild-distr -Pspark-2.3 -Phadoop2 -Dhadoop.version=2.7.3 -Pspark-scala-2.11 -Pscala-2.11 -Pweb-angular -pl '!groovy,!submarine,!mongodb,!angular,!hbase,!pig,!jdbc,!file,!flink,!ignite,!influxdb,!kylin,!lens,!cassandra,!elasticsearch,!bigquery,!alluxio,!scio,!neo4j,!sap,!scalding,!java,!beam,!hazelcastjet,!geode,!ksql,!sparql,!zeppelin-client-examples' && \
